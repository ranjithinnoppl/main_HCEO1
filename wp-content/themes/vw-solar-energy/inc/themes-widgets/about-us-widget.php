...
class VW_Solar_Energy_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Solar_Energy_About_Widget',
			__('VW About us', 'vw-solar-energy'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-solar-energy' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-solar-energy'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-solar-energy'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-solar-energy'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-solar-energy'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-solar-energy'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-solar-energy'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_solar_energy_about_custom_load_widget() {
	register_widget( 'VW_Solar_Energy_About_Widget' );
}
add_action( 'widgets_init', 'vw_solar_energy_about_custom_load_widget' );